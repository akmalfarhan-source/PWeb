        ...
        <nav class="mt-2">
            ...
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="navigation"
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="/Pweb/views/index1.php" class="nav-link">
                                <i class="nav-icon bi bi-circle"></i>
                                <p>pertemuan 1</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/Pweb/views/index2.php" class="nav-link">
                                <i class="nav-icon bi bi-circle"></i>
                                <p>pertemuan 2</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/Pweb/views/index3.php" class="nav-link">
                                <i class="nav-icon bi bi-circle"></i>
                                <p>pertemuan 3</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/Pweb/views/TGpertemuan4.php" class="nav-link">
                                <i class="nav-icon bi bi-circle"></i>
                                <p>pertemuan 4</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/Pweb/views/pertemuan5.php" class="nav-link">
                                <i class="nav-icon bi bi-circle"></i>
                                <p>pertemuan 5</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/Pweb/views/pertemuan6.php" class="nav-link">
                                <i class="nav-icon bi bi-circle"></i>
                                <p>pertemuan 6</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/Pweb/views/pertemuan7.php" class="nav-link">
                                <i class="nav-icon bi bi-circle"></i>
                                <p>pertemuan 7</p>
                            </a>
                        </li>
